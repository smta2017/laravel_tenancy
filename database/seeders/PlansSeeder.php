...
class PlansSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $freePlan->features()->saveMany([
            new Feature(['name' => 'Total_Cases', 'value' => 20, 'sort_order' => 1]),
            new Feature(['name' => 'Liberary_Searchs', 'value' => 10, 'sort_order' => 2]),
            new Feature(['name' => 'Team_members', 'value' => 1, 'sort_order' => 3]),
        ...
        $planSilver->features()->saveMany([
            new Feature(['name' => 'Total_Cases', 'value' => 200, 'sort_order' => 1]),
            new Feature(['name' => 'Liberary_Searchs', 'value' => 1000, 'sort_order' => 2]),
            new Feature(['name' => 'Team_members', 'value' => 5, 'sort_order' => 3]),
            // newFeature(['name' => 'user.add', 'value' => 30, 'sort_order' => 10, 'resettable_period' => 1, 'resettable_interval' => 'month']),
            // newFeature(['name' => 'listing_title_bold', 'value' => 'Y', 'sort_order' => 15])
        ]);
